...
#endif
#include <math.h>
#define __PYX_HAVE__grasp__ptypes
#define __PYX_HAVE_API__grasp__ptypes
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
#define __Pyx_MODULE_NAME "grasp.ptypes"
int __pyx_module_is_main_grasp__ptypes = 0;

/* Implementation of 'grasp.ptypes' */
...
static char __pyx_k_Primitive_types_constructors_Au[] = "\nPrimitive types: constructors.\n\n:Authors: - Wilker Aziz\n";
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    "ptypes",
    __pyx_k_Primitive_types_constructors_Au, /* m_doc */
    -1, /* m_size */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initptypes(void); /*proto*/
PyMODINIT_FUNC initptypes(void)
#else
PyMODINIT_FUNC PyInit_ptypes(void); /*proto*/
PyMODINIT_FUNC PyInit_ptypes(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_ptypes(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("ptypes", __pyx_methods, __pyx_k_Primitive_types_constructors_Au, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_grasp__ptypes) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "grasp.ptypes")) {
      if (unlikely(PyDict_SetItemString(modules, "grasp.ptypes", __pyx_m) < 0)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * weight = np.double             # <<<<<<<<<<<<<<
 */
  __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_double); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_weight, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init grasp.ptypes", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init grasp.ptypes");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
