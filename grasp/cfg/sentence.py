...
class Sentence(Input):
    ...
    def __init__(self, uid, words, signatures, oovs, fsa):
        self._id = uid
...
def make_sentence(uid, input_str, semiring, lexicon, unkmodel=None):
    """
    ...
    >>> from grasp.cfg import Terminal
    ...
    return Sentence(uid, words, signatures, oovs, fsa)